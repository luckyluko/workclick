...
function buyWorker() {
 ...
 if (userMoney < workerCost) {
  ...
  alert("You dont have enough for a worker You have $" + userMoney +
   " you need $" + workerCost + ".");
 ...
 document.getElementById("workerProduction").innerHTML = numWorker *
  workerIncome;
...
function buyFactory() {
 ...
 if (userMoney < factoryCost) {
  ...
  alert("You dont have enough for a factory. You have $" + userMoney +
   " you need $" + factoryCost + ".");
 ...
 document.getElementById("factoryProduction").innerHTML = numFactory *
  factoryIncome;
...
function buyNosecone() {
 ...
 if (userMoney < 1000000) {
  ...
  alert("You dont have enough for a Nose Cone. You have " + userMoney +
   " you need 1000000.");
 ...
 document.getElementById("noseconePrice").innerHTML = "PURCHASED";
...
function buyCockpit() {
 ...
 if (userMoney < 1500000) {
  ...
  alert("You dont have enough for a Cockpit. You have " + userMoney +
   " you need 1500000.");
 ...
 document.getElementById("cockpitPrice").innerHTML = "PURCHASED";
...
function buyFrame() {
 ...
 if (userMoney < 2500000) {
  ...
  alert("You dont have enough for a Frame. You have " + userMoney +
   " you need 2500000.");
...
function buyOxidizer() {
 ...
 if (userMoney < 3000000) {
  ...
  alert("You dont have enough for an Oxidizer. You have " + userMoney +
   " you need 3000000.");
 ...
 document.getElementById("oxidizerPrice").innerHTML = "PURCHASED";
...
function buyPumps() {
 ...
 if (userMoney < 3500000) {
  ...
  alert("You dont have enough for Pumps. You have " + userMoney +
   " you need 3500000.");
...
function buyNozzle() {
 ...
 if (userMoney < 4000000) {
  ...
  alert("You dont have enough for a Nozzle. You have " + userMoney +
   " you need 4000000.");
